    ...
    <div className='overflow-hidden py-[50px]'>
      <div className='mx-auto max-w-[1380px] w-full'>
        <div className='grid justify-between grid-cols-2 items-center'>
            <div className='flex text-[#082552] flex-col'>
                <h2 className='mb-5 text-7xl font-semibold'>Get a <i className='font-thin'>little</i> richer each day</h2>
                <h5 className='text-3xl py-2 font-bold w-4/5'>One small step today, a giant leap for tomorrow.</h5>
            ...
            <div className='relative'>
                ...
                <div className='bottom-[33%] -left-[14%] flex gap-2 absolute z-20'>
                ...
                <div className='top-[30%] left-[17%] flex gap-2 absolute z-20'>
                    <div className='relative flex flex-col pt-4 px-6 pb-6 rounded-xl bg-white w-[300px] border border-solid border-[#08255212] shadow-md'>
                ...
                <div className='top-[8%] right-[2%] flex gap-2 absolute z-20'>
                    <div className='relative flex flex-col pt-4 px-6 pb-6 rounded-xl bg-white w-[300px] border border-solid border-[#08255212] shadow-md'>
